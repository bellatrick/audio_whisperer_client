...
const LanguageCodeDropdown = ({ setTargetLanguage, defaultLanguage }) => {
  ...
  return (
    <div className='space-y-2 mt-4 lg:w-[50%]'>
      <label
        ...
        className='block text-green-100 font-medium'
      >
      ...
      >
        <option value='' disabled>
          Select language code (e.g., en)
        </option>
        {defaultLanguage && (
          <option
            value={'en'}
            className='hover:bg-green-100 focus:bg-green-200'
          >
            en- English
          </option>
        )}
